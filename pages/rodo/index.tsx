      ...
      <StarsBackground>
        <div className="flex-wrapper max-width-1440">
          <p>
            ...
            95/46/WE ogólne rozporządzenie o ochronie danych, w zw. z art. 11 Ustawy z dnia 10 maja 2018 o ochronie danych osobowych Dyrektor Żłobka
            Miejskiego w Krasnymstawie wyznaczył <strong>Inspektora Ochrony Danych Panią Aleksandrę Jarocką</strong>, z którą mogą się Państwo
            kontaktować we wszystkich sprawach dotyczących przetwarzania danych osobowych, za pośrednictwem adresu email: inspektor@cbi24.pl lub
